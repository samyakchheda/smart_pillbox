    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            onLongPressStart: (LongPressStartDetails details) {
              if (!widget.isGeneratingResponse && !_isRecording) {
                ...
                _animationController.forward(); // Animate the mic icon to pop
              }
            },
            onLongPressEnd: (_) {
              if (_isRecording) {
            ...
            child: ScaleTransition(
              ...
              child: IconButton(
                icon: Icon(_isRecording
                    ? Icons.stop
                    : Icons.mic), // Change icon depending on recording state
                color: _isRecording
                    ? Colors.red
          ...
          IconButton(
            icon: Icon(widget.isGeneratingResponse ? Icons.stop : Icons.send),
