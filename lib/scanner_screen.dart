...
class _ScannerScreenState extends State<ScannerScreen> {
  ...
  void _fetchScannedDocuments() async {
    final documents = await _documentService.fetchScannedDocuments(widget.userId);
    setState(() {
  ...
  void _deleteDocument(String documentId, String localPath, String thumbnailPath) async {
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          ...
                          final uploadedAt = document['uploaded_at'] ?? Timestamp.now();
