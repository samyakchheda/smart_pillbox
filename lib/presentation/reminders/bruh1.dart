...
//       medicineTimes =
//           List<String>.from(widget.existingData!['medicineTimes'] ?? []);
...
//           'medicines': [
//             medicineData
//           ], // Initialize medicines field with the new medicine
//         });
...
//             content: const Text(
//                 'Are you sure you want to decrease the dose frequency?'),
//             actions: [
//               TextButton(
...
//                     // Proceed with form submission and medicine time checking
//                     _submitForm();
//                     checkMedicineTimes(userId, flutterLocalNotificationsPlugin);
//                   },
//                   child: Text(widget.existingData != null
//                       ? 'Update Medicine'
//                       : 'Add Medicine'),
//                 ),
//               ],
