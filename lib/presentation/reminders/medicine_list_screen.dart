            ...
            child:StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data == null) {
                  return const Center(child: Text('No medicines found. Click "+" to add one.'));
                }
                ...
                var filteredMedicines = medicines.where((medicine) {
                  ...
                  bool isWithinDateRange = selectedDate.isAfter(startDate.subtract(const Duration(days: 1))) &&
                    ...
                    return Dismissible(
                      ...
                      confirmDismiss: (direction) async {
                        return await showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            content: Text('Are you sure you want to delete ${medicine['medicineNames'].first}?'),
                            actions: [
                              TextButton(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          ...
                          title: Wrap(
                            spacing: 8.0,
                            children: medicine['medicineNames']?.map<Widget>((name) => Text(
                              name,
                              style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                            ))?.toList() ?? [const Text('Unnamed')],
                          ),
